...
action_type（操作类型(0备货，1司机收货，2司机确认收货 ，司机送达仓库确认3 ， 仓库收货确认4，仓库发货，完成，5用户申请退款，6商家允许退货 7商家不允许退货 8商家同意退款 9商家拒绝退款 10用户退货信息凭证11.司机送达仓库， 司机送达用户12)）,
...
| 司机收货中 | 司机正在商家处收货进行中（1） |
| 司机确认收货 | 司机商家处收货完成(司机收货拍照) （2） |
| 司机收货完成送货仓库 | 司机送货到仓库(司机送达拍照) （3）|
| 仓库已收货 | 仓库已确认收货(仓库管理拍照) (4)|
| 已送达 | 货物已送达最终用户(司机拍照) (12)|
| 订单完成 | 订单流程全部完成 (7)|
